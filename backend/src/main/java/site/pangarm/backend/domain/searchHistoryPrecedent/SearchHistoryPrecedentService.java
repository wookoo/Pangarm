...
public class SearchHistoryPrecedentService {
    ...
    public Page<Object[]> findAllWithIsViewedBySearchHistory(SearchHistory searchHistory, Pageable page){
        return searchHistoryPrecedentRepository.findAllWithIsViewedBySearchHistoryOrderByScore(searchHistory,page);
    }
