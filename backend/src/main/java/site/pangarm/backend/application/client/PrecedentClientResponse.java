...
@Getter
public class PrecedentClientResponse {
    @JsonProperty("data")
    private List<Precedent> precedentList;

    @Getter
    public static class Precedent{
        @JsonProperty private Info info;
        @JsonProperty private double score;
        @JsonProperty private String summary;
        @JsonProperty private String judgement;
        @JsonProperty private String conclusion;
        @JsonProperty("keywords") private List<String> keywordList;

        @Getter
        public static class Info{
            @JsonProperty private String caseNumber;
            @JsonProperty private String caseName;
            @JsonProperty private String judgementDate;
            ...
            public static class Type{
                @JsonProperty private String incident;
                @JsonProperty private String courtName;
                @JsonProperty private String verdict;
            }
